...
function Home() {
  return (
    <div className='flex flex-col items-center bg-rich-gradient min-h-screen max-h-fit'>
      <Navbar />
      <div className='flex flex-col items-center justify-between relative px-4 py-8 md:p-8 lg:py-12 h-full flex-1'>
        ...
        <div className='flex flex-col items-center 2xl:flex-row h-full 2xl:mt-14 2xl:mx-4 2xl:justify-center 2xl:items-start'>
          <div className='w-3/4 mt-6 xl:w-2/5 2xl:w-2/5 2xl:mx-12'><img src={Phone} alt='CardPhoto'></img></div>
          <div className='flex flex-col items-center 2xl:items-start 2xl:mt-36 2xl:border-y-2 border-[#E5B80B] rounded-2xl 2xl:py-4'>
            <div className='p-4 mx-4 mb-6 rounded-3xl shadow-xl md:mb-0  lg:mb-6 2xl:m-0 2xl:max-w-xl 2xl:my-auto 2xl:pt-0'><h2 className='text-lg  text-center text-slate-300 tracking-wide text-opacity-80 md:text-2xl lg:text-4xl 2xl:text-left 2xl:text-2xl'>At MVCredit, we believe in providing you with unparalleled financial solutions tailored to your lifestyle. Explore our range of credit cards, each designed to cater to your unique needs.</h2></div>
